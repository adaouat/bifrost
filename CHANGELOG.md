...
- *(cmd)* Add --interactive deploy flag with TTY guard - ([6e50cda](https://github.com/adaouat/bifrost/commit/6e50cda0e5ec3ff97c8b44ece3a743f0e8a768e6)) by @bchatard

- *(deploy)* Wire --interactive step-continue prompts into the deploy pipeline - ([1fc7932](https://github.com/adaouat/bifrost/commit/1fc79321ba873aaee191d45f1ca9ebdcc7d5e570)) by @bchatard

- *(tui)* Add step-continue confirm prompt for interactive deploy - ([841fee8](https://github.com/adaouat/bifrost/commit/841fee8e6234187679de4f0f06de4e1055980afd)) by @bchatard


### 📚 Documentation

- *(roadmap)* Add M22 --interactive deploy flag - ([9217126](https://github.com/adaouat/bifrost/commit/9217126ac91a0b31b406c0c6dcc888ab3eb9c631)) by @bchatard

- *(specs)* Document --interactive flag in spec 03 and spec 06 - ([344d8f7](https://github.com/adaouat/bifrost/commit/344d8f7508166b426bedebc7f51c68a1dc044a20)) by @bchatard


### 🧪 Testing

- *(cmd)* Integration test for --interactive scripted-confirm deploy - ([e30209a](https://github.com/adaouat/bifrost/commit/e30209a98c82fe43edc2e27e01f083c164bc604c)) by @bchatard

## [0.23.1](https://github.com/adaouat/bifrost/compare/v0.23.0..v0.23.1) - 2026-06-15

### 🧪 Testing

- *(cmd)* Verify SIGINT after extraction warns and deploy completes - ([37e93b8](https://github.com/adaouat/bifrost/commit/37e93b8315442715f9dda42e3b720cd88587c965)) by @bchatard
